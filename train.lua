...
function Train:new(line_stack)
    ...
    self.train_up = love.graphics.newImage("images/TrainUp.png")
    self.train_down = love.graphics.newImage("images/TrainDown.png")
    self.train_left = love.graphics.newImage("images/TrainLeft.png")
    self.train_right = love.graphics.newImage("images/TrainRight.png")
    self.image = love.graphics.newImage("images/TrainUp.png")
end
